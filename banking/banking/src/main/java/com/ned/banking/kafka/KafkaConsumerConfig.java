...
public class KafkaConsumerConfig {
	...
	public ConsumerFactory<String, Log> consumerFactory() {
		...
		props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.ned.banking.model");
		return new DefaultKafkaConsumerFactory<String, Log>(props);
	}

	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, Log> kafkaListenerContainerFactory() {
		ConcurrentKafkaListenerContainerFactory<String, Log> factory = new ConcurrentKafkaListenerContainerFactory<String, Log>();
